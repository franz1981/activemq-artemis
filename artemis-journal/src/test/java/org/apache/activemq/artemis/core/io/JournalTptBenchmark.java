...
public class JournalTptBenchmark {
   ...
   public static void main(String[] args) throws Exception {
      ...
      switch (type) {
         ...
         case Nio:
            factory = new NIOSequentialFileFactory(tmpDirectory, true, ArtemisConstants.DEFAULT_JOURNAL_BUFFER_SIZE_NIO, 1927999, 1, false, null).setDatasync(dataSync);
            break;
         case Aio:
            factory = new AIOSequentialFileFactory(tmpDirectory, ArtemisConstants.DEFAULT_JOURNAL_BUFFER_SIZE_AIO, 1927999, 500, false, null).setDatasync(dataSync);
