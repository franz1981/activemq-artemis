...
public class ReplicationPrimaryPolicy implements HAPolicy<ReplicationPrimaryActivation> {
   ...
   private ReplicationPrimaryPolicy(ReplicationPrimaryPolicyConfiguration configuration) {
      ...
      backupPolicy = ReplicationBackupPolicy.failback(configuration.getQuorumVoteWait(), configuration.getVoteRetries(),
                                                         configuration.getVoteRetryWait(), configuration.getRetryReplicationWait(),
                                                         configuration.getClusterName(), configuration.getGroupName(),
                                                         this,
