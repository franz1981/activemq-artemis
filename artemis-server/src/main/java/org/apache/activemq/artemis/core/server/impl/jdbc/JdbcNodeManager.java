...
public final class JdbcNodeManager extends NodeManager {
    ...
    */
   private void lock(LeaseLock lock) {
      ...
      switch (acquireResult) {
         case Timeout:
            throw new IllegalStateException("LeaseLock timeout");
         case Exit:
            throw new IllegalStateException("LeaseLock was interrupted");
         case Done:
            break;
         default:
    ...
    */
   private boolean lockLiveAndCheckLiveState() {
